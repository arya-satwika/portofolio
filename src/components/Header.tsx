...
export function Header({ className }: { className?: string }){
  return(
      <div className={`header-font flex flex-col mb-2 mt-25 mx-auto gap-2 bg-gradient-start/30 backdrop-blur-sm max-h-20 max-w-2xl ${className}`}>
        ...
        <h2 className="mt-2 text-lg text-main-red">Web Developer / Video Editor</h2>
          ...
          <div className="flex justify-between pt-3">
            ...
            <span className="text-white pt-1 flex flex-row gap-4 font-medium">
